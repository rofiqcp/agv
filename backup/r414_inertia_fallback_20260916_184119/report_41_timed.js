...
const R41_PROFILES={
  ...
  'R4.1.4':{title:'Karakteristik Heading NEO3 & Inersia • Akuisisi 60 Detik',targetHz:50,primary:'imu',channels:['neo3_mag_heading','imu_inertial_heading','imu','neo3_mag'],countLabels:{neo3_mag_heading:'N NEO3 heading',imu_inertial_heading:'N Inersia',imu:'N IMU',neo3_mag:'N NEO3 mag'},detailHint:'Heading NEO3 dan inersia direkam pada rate sumber aktual; gyro IMU ditargetkan 50 Hz. Mean heading dihitung secara circular, bukan mean aritmatika biasa.',metrics:[
    {key:'neo_compass',label:'NEO3 compass',unit:'°',channel:'neo3_mag_heading',angular:true,pick:v=>r41RadToCompassDeg(v?.yaw_rad)},
    {key:'inertia_compass',label:'Inersia compass',unit:'°',channel:'imu_inertial_heading',angular:true,pick:v=>r41RadToCompassDeg(v?.yaw_rad)},
    {key:'delta_heading',label:'Δ Inersia−NEO3',unit:'°',channel:'imu_inertial_heading',pick:()=>report41HeadingMetric('derived.r41_heading_delta_deg')},
    {key:'inertia_drift',label:'Drift inersia',unit:'°',channel:'imu_inertial_heading',pick:()=>report41HeadingMetric('derived.r41_heading_drift_deg')},
...
function r41HeadingPair(){const n=r41Num(state?.neo3_mag_heading?.yaw_rad),i=r41Num(state?.imu_inertial_heading?.yaw_rad);const neo=r41RadToCompassDeg(n),inertia=r41RadToCompassDeg(i);return{neo,inertia,delta:Number.isFinite(neo)&&Number.isFinite(inertia)?r41WrapDeg180(inertia-neo):NaN}}
