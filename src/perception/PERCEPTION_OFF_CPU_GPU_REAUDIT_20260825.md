...
- `cpu` = direct TorchScript `/home/otomasi/ros/models/yolopv2.pt` via LibTorch; tidak ada ONNX runtime.
- `gpu` = CUDA/TensorRT `/home/otomasi/ros/models/yolopv2.engine` pada Jetson target.
