...
class ReportsPage:public QWidget{
  ...
  QStringList bagTopics()const{
    return {
      "/tf","/tf_static","/imu/data","/gnss/fix_raw","/gnss/quality","/gnss/vel","/gnss/velocity_position_fit","/gnss/vel_map","/gnss/base_velocity","/gnss/base_velocity_fusion","/gnss/cog_heading_fusion","/gnss/motion_validation","/gnss/fusion_status","/esc/odom","/odometry/filtered","/odometry/filtered_map","/cmd_vel_nav_raw","/cmd_vel/autonomy_pre_smoother","/cmd_vel/pre_smoother","/cmd_vel/autonomy_integrated","/cmd_vel/nav2_pre_collision","/cmd_vel/collision_preview","/cmd_vel","/cmd_vel/actuator","/esc/drive_target_mps","/esc/drive_actual_mps","/esc/steering_target_rad","/esc/steering_actual_rad","/navigation/mppi_closed_loop/status","/navigation/trajectory_safety_state","/collision_monitor/state","/system/localization_state","/navigation/goal_state"
    };
  }
  void startRosbag(){
