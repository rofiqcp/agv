...
need("'teleop_topic': '/cmd_vel/teleop_disabled_after_router'" in launch,'ESC direct teleop must be disabled in autonomous runtime')
...
print('PASS final cmd_vel chain: sources -> safety/mux -> velocity_smoother -> /cmd_vel -> ESC/USART')
